# -*- coding: utf-8 -*-
"""
Created on Sat Aug  6 16:43:21 2022
...
player1_score = Label(root, text="Player1", bg="red", fg="white")
player1_score.place(relx=0.1, rely=0.4, anchor=CENTER)
player2_score = Label(root, text="Player2", bg="red", fg="white")
player2_score.place(relx=0.9, rely=0.4, anchor=CENTER)

pokemon_list = [pikachu, bulbasour, Iyvasour, Charmender,
                Squirtle, Ratata, jigglypuff, meowth, Persion, abra, kadabra]
